...
@Component({
  ...
  exportAs: 'regularResultsDropdown',
  // eslint-disable-next-line @angular-eslint/component-selector
  selector: '[appRegularResultsDropdown]',
  templateUrl: './regular-results-dropdown.component.html'
})
export class RegularResultsDropdownComponent {
