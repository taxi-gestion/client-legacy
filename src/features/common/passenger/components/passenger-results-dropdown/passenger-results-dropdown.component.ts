...
@Component({
  ...
  exportAs: 'passengerResultsDropdown',
  // eslint-disable-next-line @angular-eslint/component-selector
  selector: '[appPassengerResultsDropdown]',
  templateUrl: './passenger-results-dropdown.component.html'
})
export class PassengerResultsDropdownComponent {
