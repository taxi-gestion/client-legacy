...
@Component({
  ...
  exportAs: 'clientResultsDropdown',
  // eslint-disable-next-line @angular-eslint/component-selector
  selector: '[appClientResultsDropdown]',
  templateUrl: './client-results-dropdown.component.html'
})
export class ClientResultsDropdownComponent {
