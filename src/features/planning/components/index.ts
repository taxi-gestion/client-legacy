...
import { ReturnToScheduleFieldComponent } from './fares/returns-to-schedule-field/return-to-schedule-field.component';
import { ReturnToScheduleResultsDropdownComponent } from './fares/return-to-schedule-results-dropdown/return-to-schedule-results-dropdown.component';
...
export const COMPONENTS = [
  ...
  FareCardComponent,
  ReturnToScheduleFieldComponent,
  ReturnToScheduleResultsDropdownComponent
];
