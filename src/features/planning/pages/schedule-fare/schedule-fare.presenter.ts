...
import { defaultPlaceValue, regularOrStringToPassenger, toLocalTime } from '../../common/fares.presenter';
import { pipe as fpPipe } from 'fp-ts/function';
import { fold as eitherFold } from 'fp-ts/Either';
import { regularIdentity, throwDecodeError } from '../../common/regular.presenter';
...
export const toScheduleFareSuccessToast = (fares: FaresScheduled): Toast => ({
  content: `Course pour ${fares.scheduledCreated.passenger.passenger} par ${
...
export const updateRegularLinkedControls =
  ...
  (regular: Entity & RegularDetails): void => {
    form.controls.passenger.setValue(regularIdentity(regular));
