type FormControlErrorsNames = 'destinationName' | 'lastname' | 'phoneNumber' | 'phoneType';

export const PLANNING_FORM_CONTROL_ERROR_MESSAGES: Record<FormControlErrorsNames, (controlValue: unknown) => string> = {
