...
export type DeleteRegularAction = (regularIdToDelete: string) => Observable<RegularDeleted>;

export const DELETE_REGULAR_ACTION: symbol = Symbol('planning.delete-regular.action');
