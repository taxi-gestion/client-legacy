...
export const FIELD_ERROR_MESSAGES_CONFIGURATION: 'authentication.field-error-messages.configuration' =
  'authentication.field-error-messages.configuration' as const;
